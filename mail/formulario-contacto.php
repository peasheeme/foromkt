<?php
	...
	if(empty($_POST['c_name']) ||
		...
		$contenido = '
			...
			<head></head>
			<body>
				<p> <strong> '.$nombre.'ha enviado el siguiente mensaje a través del sitio web <br>
				 https://www.3e-digital.com/foromkt/index.html </strong> </p>
				<br>
				<p>'.$mensaje.'</p>
				<br>
		...
		if($envio){
			...
			echo "<script>window.location.href='https://www.3e-digital.com/foromkt/index.html';</script>";
		}else{
